...
# Image Settings
treeimg = PhotoImage(file='trees.png')
piknightimg = PhotoImage(file='mathoknight.png')
treesmaller = treeimg.subsample(4, 4)
piknightsmaller = piknightimg.subsample(4, 4)
...
def mainpage():
    ...
    # game box
    game_canvas = tk.Canvas(gui, width=900, height=300,
                            bg="#dc71fa", highlightbackground="#9961da", highlightthickness=4)
    game_canvas.grid(row=1, column=0, columnspan=4, pady=20)

    global piknight
    piknight = tk.Label(gui,
                        image=piknightsmaller,
                        bg=lightpurple,
                        # width=100,
                        # height=100,
                        )
    piknight.grid(row=1, column=2, columnspan=4)

    global trees
    trees = tk.Label(gui,
                     image=treesmaller, bg=lightpurple,)
    trees.grid(row=1, column=0, columnspan=2)
